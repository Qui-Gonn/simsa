...
public abstract class GetAllItemsHandler<TItem>(IGenericRepository<TItem> repository)
...
public abstract class GetItemByIdHandler<TItem>(IGenericRepository<TItem> repository)
...
public abstract class AddItemHandler<TItem>(IGenericRepository<TItem> repository)
...
public abstract class UpdateItemHandler<TItem>(IGenericRepository<TItem> repository)
...
public abstract class DeleteItemHandler<TItem>(IGenericRepository<TItem> repository)
